# SIG Skeleton Definition - M. Kallmann 2017
...
root pos
{ offset 0 0 0
  channel XPos 0 lim -5000 5000
  channel YPos 0 lim -5000 5000
  channel ZPos 0 lim -5000 5000
  channel Quat
  ...
  { offset 0 91.5 0
      visgeo primitive
             ...
             color 40 52 96 255;
    channel XPos 0 lim -50 50
    channel YPos 0 lim -50 50
    channel ZPos 0 lim -50 50
    channel Quat
    ...
    { offset 0 0 0 
      ...
      { offset -8 -4.16 0
        visgeo primitive
               ...
               material amb 51 51 51 255 dif 40 52 96 255 spe 0 0 0 255 emi 0 0 0 255 shi 10;
        ...
        { offset 0 -40.735 0
          ...
          { offset 0 -38 0
            visgeo primitive
                   box 4 2 12 20
                   center 0 -5.5 6.5
                   material amb 51 51 51 255 dif 111 65 43 255 spe 0 0 0 255 emi 0 0 0 255 shi 10;
